...
<div class="container">
			...
			<?php
				...
				foreach($_SESSION["carrinho"] as $linha =>$dado)
				{
					...
					echo "<tr>
						  ...
						  <td>$subtotal</td>
	<td><a href='/loja_mvc/excluir_carrinho?linha=$linha'><img src='imagens/lixeira.png'></a></td>
						  </tr>";
				}
			?>
		</tbody>
	...
	<a class="btn btn-primary" href="/loja_mvc/">Continuar Comprando</a>&nbsp;&nbsp;&nbsp;
	
	<?php
			if(count($_SESSION["carrinho"]) > 0)
			{
				echo "<a class='btn btn-primary' href='/loja_mvc/finalizar_venda'>Finalizar a Compra</a>";
			}
		}
		else
		{
...
<script>
	function alterar(elemento)
	{
		...
		if(quant > 0)
		{
			var url = "/loja_mvc/alterar_carrinho?quant=" + quant + "&linha=" + linha;
