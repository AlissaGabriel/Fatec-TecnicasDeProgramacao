...
<?php
				foreach($retorno as $dado)
				{
					echo "<li class='nav-item'>
						  <a class='nav-link fw-bold'  href='/loja_mvc/produtos_categoria?idcategoria={$dado->id_categoria}'>{$dado->descritivo}</a>
						  </li>";
				}
			?>
	</ul>
	...
	<div id="produtos" class="d-flex justify-content-around align-items-center">
		<?php
			...
			foreach($produtos as $produto)
			{
				...
				<a href='/loja_mvc/inserir_carrinho?id={$produto->id_produto}' class='btn btn-primary'>Comprar</a>
				</div>
				</div>";
			}
		?>
